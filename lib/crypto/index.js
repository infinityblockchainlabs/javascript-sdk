...
var bip39 = _interopRequireWildcard(_bip3);
 ...
 */
var getAddressFromPublicKey = exports.getAddressFromPublicKey = function getAddressFromPublicKey(publicKeyHex, prefix) {
 ...
 * @param {string} privateKeyHex the private key hexstring
 */
var getAddressFromPrivateKey = exports.getAddressFromPrivateKey = function getAddressFromPrivateKey(privateKeyHex, prefix) {
...
var getPrivateKeyFromKeyStore = exports.getPrivateKeyFromKeyStore = function getPrivateKeyFromKeyStore(keystore, password) {
  ...
  if (!_is_js2.default.string(password)) {
    throw new Error("No password given.");
  }

  var json = _is_js2.default.object(keystore) ? keystore : JSON.parse(keystore);
 ...
 */
var validateMnemonic = exports.validateMnemonic = bip39.validateMnemonic;

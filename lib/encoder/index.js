 ...
 * @return bytes {Buffer}
 */
export const convertObjectToSignBytes = obj => Buffer.from(JSON.stringify(sortObject(obj)));
...
const isDefaultValue = obj => {
  ...
  return is.number(obj) && obj === 0 || is.string(obj) && obj === "" || is.array(obj) && obj.length === 0;
};